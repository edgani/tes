"""us_stocks.py — US Stocks Tab v40.8 (Keith Filtered + Fallback)

Renders tickers dari snap["us_stocks"] — pakai Keith filtered kalau ada, kalau tidak fallback ke semua.
"""
...
def render(snap: dict):
    ...
    keith_filtered = snap.get("us_stocks_keith_filtered", [])
    keith_meta = snap.get("us_stocks_keith_meta", {})

    # Get all tickers for this tab
    tab_data = snap.get("us_stocks", {})
